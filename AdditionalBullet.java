 ...
 * 
 * This class AdditionalBullet extends Powerups. When we create an object of this class, we will use this 
...
/**
 * The {@link AdditionalBullet} class is for the @param AdditionalBullet powerUp which gives the player an additional bullet if 
 * they have fired their first one already. It extends {@link PowerUps} and is given its location with row ('r'), 
 * and column ('c') coordinate on the {@link Grid}, and is 
 * represented by 'A'. But they will not show in the game, unless the player 'debugs' to show what is in the {@link Grid}.
 * @author Cesar_2
 *
 */
...
{
	public AdditionalBullet(int r, int c)
	{
		super(r,c,"A");
	}
}