 ...
 * 
 * This class Radar extends Powerups. When we create an object of this class, we will use this 
...
/**
 * The {@link Radar} class is for the @param Radar powerUp which reveals to the player in which room the briefcase is 
 * located. It extends {@link PowerUps} and is given its location with row ('r'), and column ('c') coordinate 
 * on the {@link Grid}, and is represented by 'A'. But they will not show in the game, unless the player @param debugs
 * to show what is in the {@link Grid}.
 * @author Cesar_2
 *
 */
